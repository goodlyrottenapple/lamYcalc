...
We first examine the definition of untyped \(\beta\)-reduction, defined
for the mechanization using nominal sets:
...
\(\lambda\)-term \(M\), \(x\ \sharp\ M\) iff \(x \not\in FV(M)\), where
we take the usual definition of \(FV\):
