...
\texttt{(∩ (Data.List.map (λ τk -> (∩ τi \textasciitilde > τk)) τi) \textasciitilde > τ)}
...
The only open branch in the above tree is to show that
