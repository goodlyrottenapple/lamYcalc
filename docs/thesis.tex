...
is accompanied by an electronic appendix with machine- checked
proofs?''\\
(B. E. Aydemir et al. (\protect\hyperlink{ref-aydemir05}{2005}))
\end{quote}

Indeed, the following two chapters take inspiration from the \(poplm\)
challenge and try to asses the merits of different mechanizations of
binders in the \(\lamy\) calculus as well compare two different
...
Test reference to lemma \ref{test}. \#Intersection types
...
\section{Intersection-type
assignment}\label{intersection-type-assignment-1}
...
\subsection{Inversion lemmas}\label{inversion-lemmas-1}
...
\section{Proofs of subject expansion and
reduction}\label{proofs-of-subject-expansion-and-reduction-1}
