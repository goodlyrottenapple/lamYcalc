...
The typing relation \textbf{add link to future def} was also modified to
include type refinement \textbf{\ldots{} didn't want to include it here
because it will differ significantly from the initial}
