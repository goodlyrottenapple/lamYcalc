...
equivalent de Bruijn terms. We therefore chose the locally nameless
approach for one of our mechanizations and put these claims to test in
\cref{chap:compIsa}.
...
\(\Vdash\) is closed under \(\beta\)-equality. This means that given a
...
confusion, we present the two clauses using the list notation, defined
in \cref{notation}:
...
less of a discussion of transparency of proofs. Even though
